...
import netpipe.core.Job;
import netpipe.core.Task;
...
public class JobGenerator {
        ...
        for (Method m : methods) {
            ...
            if (task != null) {
                ...
                for (Type paramType : m.getGenericParameterTypes()) {
                    ...
                    } else if (paramType.toString().contains("netpipe.core.Context")) {
    ...
    private static void createSourceAndJar(JobDes jobInfo) throws IOException {
        ...
        for (TaskDes task : jobInfo.getTasks()) {
            ...
            File srcFile = new File(srcDir, task.name() + ".java");
